...
/// @brief trunca un fichero/directorio a los bytes indicados como nbytes, liberando los bloques necesarios
/// @param ninodo
/// @param nbytes
/// @return bloques liberados o -2 (no se tienen permisos) o FALLO
int mi_truncar_f(unsigned int ninodo, unsigned int nbytes)
{
    ...
    if ((inodo.permisos & 2) != 2)
    {
        fprintf(stderr, RED "No hay los permisos necesarios\n" RESET);
        return -2;
    }
